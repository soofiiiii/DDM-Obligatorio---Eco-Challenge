...
export default function RegisterScreen() {
  ...
  const checkPasswordStrength = (password) => {
    ...
    else errors.push("Debe contener una mayúscula.");
    if (/[a-z]/.test(password)) strength++;
    else errors.push("Debe contener una minúscula.");
    if (/[0-9]/.test(password)) strength++;
    else errors.push("Debe contener un número.");
    if (/[!@#$%^&*(),.?":{}|<>]/.test(password)) strength++;
    else errors.push("Debe tener un carácter especial.");
  ...
  const validarYRegistrar = async () => {
    ...
    if (edadCalculada < 13 || edadCalculada > 100) {
      Alert.alert(
        "Error",
        "Lo sentimos, esta app está pensada para mayores de 13 años."
      );
      return;
    }
    ...
    if (exito) {
      const usuarioLogueado = loginUsuario(
        nuevoUsuario.email,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.passwordContainer}>
        ...
        {/* Wrapper del ícono de advertencia + tooltip */}
          ...
          <View style={styles.tooltipWrapper}>
            ...
            {showTooltip && (
              <View style={styles.tooltipBox}>
                <Text style={styles.tooltipTitle}>Tu contraseña necesita:</Text>
      ...
      >
        ...
        >
          <View style={styles.bottomSheetContainer}>
            <Text style={styles.modalTitle}>Seleccionar fuente de imagen</Text>

            <TouchableOpacity
              style={styles.option}
              onPress={takePhotoFromCamera}
            >
              <Icon name="camera" size={24} color="#333" style={styles.icon} />
            ...
            >
              <Icon name="image" size={24} color="#333" style={styles.icon} />
